...
def inputFileParse():
    ...
    parser.add_argument('-f', '--file', type=lambda x: is_valid_file(parser, x), metavar="FILE", default='SCD.scd',  help='Name of xml-like 61850 file for %(prog)s program', required=False)
    parser.add_argument('-ip', '--ip', dest='IED', required=False, help='IED\'s IP Address')
    return parser
