...
# returns a dictionary of Varname : Tuple (data, quality triggers)
    ...
    def test_report_control(self, ied_ld_name, clt):
        print()
        print('getting RCB')
        ref_rcb = 'RP2_19LD0/LLN0.BR.brcbMX01'
        # ref_rcb = 'TEMPLATELD0/LLN0.BR.brcbMX01'
        clt.getDataSetDirectory()
        # ref_rcb = 'ECISepam80_8/LLN0.BR.brcbMX01'
        # clt.get_rcb('TEMPLATELD0/LLN0.BR.brcbMX01')
        clt.get_rcb(ref_rcb)
        clt.install_handler(ref_rcb)
        # clt.get_rcb('RP2_19LD0/LLN0.BR.brcbST01')
        # clt.get_report_enabled()
        # clt.install_handler_from_c()
        # clt.install_handler()
        # clt.get_report_enabled()
